...
DocumentReference? get currentUserReference =>
    loggedIn ? HealstorageRecord.collection.doc(currentUser!.uid) : null;

HealstorageRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : HealstorageRecord.getDocument(HealstorageRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
